var UI = (function () {
    ...
    var unlockApp = function () {
        ...
        setTimeout(function () {
            $(".welcomeRing1").css({
                'background-image': 'url(static/images/welcomeRing1G.png)'
            });
        }, 500);
        setTimeout(function () {
            $(".welcomeRing2").css({
                'background-image': 'url(static/images/welcomeRing2G.png)'
            });

        }, 1000);
        setTimeout(function () {
            $(".welcomeRing3").css({
                'background-image': 'url(static/images/welcomeRing3G.png)'
            });
